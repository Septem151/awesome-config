...
globalkeys = gears.table.join(
    ...
    awful.key({}, "XF86AudioMute", function() awful.spawn("amixer -q -D pulse set Master toggle") end,
    ...
    awful.key({ modkey,           }, "a",
        ...
        {description = "focus previous window", group = "layout"}
    ),
    ...
    awful.key({ modkey, "Shift"   }, "a", function () awful.client.swap.byidx( -1)    end,
              {description = "swap with previous window", group = "layout"}),
    ...
    awful.key({ modkey, "Control"   }, "w",     function () awful.tag.incnmaster( 1, nil, true) end,
              {description = "increase the number of master clients", group = "layout"}),
    awful.key({ modkey, "Control"   }, "s",     function () awful.tag.incnmaster(-1, nil, true) end,
    ...
    awful.key({ modkey, "Shift" }, "m", function() awful.layout.set(awful.layout.suit.tile) end,
              {description = "master layout", group = "layout"}),
    awful.key({ modkey, "Shift" }, "g", function() awful.layout.set(awful.layout.suit.fair) end,
              {description = "grid layout", group = "layout"}),
    awful.key({ modkey, "Shift" }, "r", function() awful.layout.set(awful.layout.suit.spiral.dwindle) end,
              {description = "ratio layout", group = "layout"}),

    -- Prompt
    awful.key({ modkey },            "r",     function () awful.util.spawn("rofi -show run") end,
              {description = "run prompt", group = "launcher"}),
    awful.key({modkey }, "o", function () awful.util.spawn("rofi -show drun -show-icons") end,
              {description = "run app", group = "launcher"})
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift" }, "w",
		  ...
		  awful.tag.viewprev()
              ...
              {description = "move client to previous workspace", group = "client"}),
    awful.key({ modkey, "Shift" }, "s",
	      ...
	      {description = "move client to next workspace", group = "client"}),
